...
// SCROLL BLOG VIEW
sr.reveal(".blogview__img", { delay: 500 });
sr.reveal(".blogview__subtitle", { delay: 300 });
sr.reveal(".blogview__desc", { delay: 400 });
sr.reveal(".blogview__text", { delay: 500 });
sr.reveal(".blogview__list", { delay: 600 });
